...
#define NGX_HTTP_WASM_UPSTREAM_PHASE       (NGX_HTTP_LOG_PHASE + 1)
#define NGX_HTTP_WASM_HEADER_FILTER_PHASE  (NGX_HTTP_LOG_PHASE + 2)
#define NGX_HTTP_WASM_BODY_FILTER_PHASE    (NGX_HTTP_LOG_PHASE + 3)
#ifdef NGX_WASM_RESPONSE_TRAILERS
#define NGX_HTTP_WASM_TRAILER_FILTER_PHASE (NGX_HTTP_LOG_PHASE + 4)
#endif
